// lesson.17.hw.js.3.kulemichev.25.12.2021

/*
 * #1
 *
 * Создайте функцию counter(), которая должна реализовать счетчик с помощью
 * замыкания:
 ...
 * #2
 *
 * Создайте функцию counting, которая должна реализовать три метода
 * с помощью замыкания:
 * первоначальное значение счетчика – 0
 * counting.value() – возвращает значение счетчика
 * counting.value(n) – устанавливает значение счетчика,
 ...
 * #3
 *
 * Создайте функцию myPow(a, b, myPrint). Внутри реализуйте рекурсию
 * для подсчета результата возведения числа a в степень b.
 * функция myPrint(a, b, res) – глобальная функция, которая должна
 * генерировать из параметров a, b, res строку вида 'a^b=res' и возвращать ее
 * myPrint() должна быть передана в myPow() как параметр и вызвана
 * внутри как callback-функция
 * функция myPow() в качестве возвращаемого значения принимает
 * результат myPrint()
 * Например:
...
console.log(car.info()); //Ford Focus,  2.5cc, year 1998, used
car.used = "new";
console.log(car.info()); //Ford Focus,  2.5cc, year 2022, new
car.used = "used";
console.log(car.info()); //Ford Focus,  2.5cc, year 2022, new
console.log(car2.info()); //Opel Zafira,  1.8cc, year 2008, used
car.used = "used";
console.log(car2.info()); //Opel Zafira,  1.8cc, year 2008, used
 ...
 * произвольный числовой массив и возвращает максимальное число из
 ...
 * #8
 *
 * Создайте функцию myMul(a, b), которая будет умножать числа а и b,
 * возвращая результат.
 */
// function myMul(a, b) {
//   return a * b
...
console.log(myUniq(notUniqNums)); //1, 2, 3, 4, 5, 6, 7 
console.log(myUniq(notUniqStrings)); //'Bob', 'Kate', 'John', 'Tom' 
